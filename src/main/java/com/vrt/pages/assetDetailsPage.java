...
// Click on "No" button from the delete confirmation pop-up
 ...
 // select any setup from asset details page
	...
	public void Click_SetupName(String SN) throws InterruptedException, IOException {
		...
		List<WebElement> SetupList = driver.findElementByName("VRT.DataModule.Asset.ViewModels.ActivityItemViewModel").findElements(By.className("TextBlock"));
 ...
 // Select any qual file and click on that
    ...
    List<WebElement> QUALList = driver.findElementByName("VRT.DataModule.Asset.ViewModels.ActivityItemViewModel").findElements(By.className("TextBlock"));
   // Loop for the different serial number created
 ...
 // Select any report file and click on that
    ...
    List<WebElement> REPORTList = driver.findElementByName("VRT.DataModule.Asset.ViewModels.ActivityItemViewModel").findElements(By.className("TextBlock"));
